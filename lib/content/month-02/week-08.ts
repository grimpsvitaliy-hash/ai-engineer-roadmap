      ...
      blocks: [
        {
          type: "funfact",
          emoji: "💬",
          title: "Первый чат-бот — психотерапевт из 60-х",
          content:
            "В **1966 году** Джозеф Вейценбаум в MIT написал **ELIZA** — программу-психотерапевта на 200 строк кода. Она просто переформулировала твои слова в вопросы. Люди настолько эмоционально привязывались, что секретарша Вейценбаума **попросила его выйти из кабинета**, пока она общается с ELIZA. Вейценбаум был в ужасе — он не ожидал такого эффекта. Это породило целую дискуссию о морали в AI.",
        },
        {
          type: "funfact",
          emoji: "🎭",
          title: "Тест Тьюринга прошли... и забыли",
          content:
            "**Тест Тьюринга** (1950) — может ли компьютер обмануть человека что он человек. В 2014 году чат-бот **Eugene Goostman** (играющий 13-летнего украинца, плохо знающего английский) убедил **33% судей** что он человек — формально прошёл тест. Никто особо не отметил. В 2024 году GPT-4 уверенно проходит тест с большинством людей. Тьюринг бы не поверил.",
        },
        {
          type: "funfact",
          emoji: "🤖",
          title: "Бот, который лучше человека в Dota",
          content:
            "**OpenAI Five** в 2019 победил чемпионов мира по Dota 2 в матче 2:0. На тренировку ушло **180 лет игрового времени в день** (распараллеленных). После победы OpenAI не делал из этого продукт — это была демонстрация возможностей RL. Сейчас компания фокусируется на LLM, и многие исследователи RL ушли в Anthropic, Cohere и собственные стартапы.",
        },
      ],
    },
  ],
