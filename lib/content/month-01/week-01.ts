      ...
      blocks: [
        {
          type: "funfact",
          emoji: "🐍",
          title: "Откуда название Python",
          content:
            "Python назван **НЕ в честь змеи**. Создатель Гвидо ван Россум был фанатом британского комедийного шоу **Monty Python's Flying Circus** и захотел «короткое, уникальное, слегка загадочное» имя. Поэтому в Python-документации до сих пор любят примеры с `spam` и `eggs` — это отсылка к их культовому скетчу про спам в кафе.",
        },
        {
          type: "funfact",
          emoji: "📐",
          title: "Война отступов",
          content:
            "Holy War в IT: **табы или пробелы?** В сериале «Кремниевая долина» (Silicon Valley) этот вопрос разрушает отношения главных героев. По исследованию Stack Overflow 2017, разработчики на пробелах зарабатывают **больше** чем на табах. Корреляция, не причина — но мем живёт. Сам Гвидо рекомендует **4 пробела**, это закреплено в PEP 8.",
        },
        {
          type: "funfact",
          emoji: "🥚",
          title: "Пасхалки в Python",
          content:
            "Открой Python и набери `import this` — выведется **Zen of Python**, неформальный кодекс языка. А `import antigravity` откроет в браузере [старый xkcd-комикс](https://xkcd.com/353/) про человека, который взлетел потому что «выучил Python». Эти пасхалки лежат в стандартной библиотеке десятилетиями.",
        },
      ],
    },
  ],
