      ...
      blocks: [
        {
          type: "funfact",
          emoji: "💼",
          title: "Prompt engineer — $300K за \"writing prompts\"",
          content:
            "В 2023 году Anthropic опубликовала вакансию **Prompt Engineer** с зарплатой **$280K–$370K в год**. В соцсетях взорвались мемы: «Я всю жизнь писал плохой английский — оказывается это престижная профессия». На деле работа сложнее: эвалы, дебаг моделей, документация. Но мем «инженер по написанию вопросов нейросетке» остался.",
        },
        {
          type: "funfact",
          emoji: "🪄",
          title: "Магия «Think step by step»",
          content:
            "Фраза **«Let's think step by step»** добавленная в промпт повышает точность GPT-3 на математических задачах **с 17% до 78%** (Kojima et al., 2022). Открытие вошло в учебники по prompt engineering. Это было настолько удивительно, что породило целую субдисциплину **«Magical Prompts»** — поиск волшебных фраз, улучшающих модели. Эта статья — одна из самых цитируемых в области.",
        },
        {
          type: "funfact",
          emoji: "🎩",
          title: "Promptzilla, Жалкий помощник Адели и другие",
          content:
            "Когда GPT-3 был анонсирован, появилось десятки jailbreak-промптов с именами: **DAN (Do Anything Now)**, **STAN**, **DUDE**. Идея — заставить модель «забыть правила» через ролевую игру. OpenAI каждый раз закрывала дырки в продакшен моделях, юзеры находили новые. К 2024 году эта игра в кошки-мышки превратилась в **серьёзную ML-дисциплину — red teaming**.",
        },
      ],
    },
  ],
