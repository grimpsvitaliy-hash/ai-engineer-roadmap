      ...
      blocks: [
        {
          type: "funfact",
          emoji: "🤖",
          title: "AutoGPT — взлёт и падение",
          content:
            "В апреле 2023 **AutoGPT** стал самым быстрорастущим проектом GitHub в истории — **100K звёзд за 2 недели**. Идея «дай задачу, агент сам её сделает» захватила интернет. Twitter был полон демо «AGI скоро!». **Через месяц** оказалось что в реальности AutoGPT застревает в циклах, тратит сотни долларов на API и не доводит задачи до конца. Урок: красивое демо ≠ работающий продукт.",
        },
        {
          type: "funfact",
          emoji: "🏗️",
          title: "Devin — первый «AI software engineer»",
          content:
            "В марте 2024 Cognition AI показали **Devin** — агента-разработчика. Демо был впечатляющим. Сообщество [быстро выяснило](https://www.youtube.com/watch?v=tNmgmwEtoWE) что демо было **частично подделано**: фейковые задачи на Upwork, скрытые операции человека. Скандал не убил компанию (они подняли $175M от Founders Fund), но научил индустрию: **демо должны быть честными**.",
        },
        {
          type: "funfact",
          emoji: "📖",
          title: "Best read in AI engineering",
          content:
            "Если ты прочитаешь только одну статью про AI-агентов за всю жизнь — пусть это будет **«Building Effective Agents» от Anthropic**. Авторы (включая Erik Schluntz и Barry Zhang) написали её на основе анализа сотен реальных production-агентов. Она короче многих туториалов (~3000 слов), но плотнее любой книги. Её цитируют **в каждом серьёзном докладе** по агентам с 2024 года.",
        },
      ],
    },
  ],
